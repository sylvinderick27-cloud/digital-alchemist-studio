  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-6 py-20 bg-white">
      ...
      <div className="max-w-7xl w-full relative z-10">
        ...
        >
          {/* Text that inverts over the image */}
          <div className="mix-blend-difference text-white">
            ...
            <motion.p
              className="text-lg md:text-xl max-w-2xl mb-12 ml-2"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 1, delay: 0.6 }}
            >
              Crafting realistic real-time models and immersive digital twin
              experiences.
            </motion.p>
          </div>

          {/* Buttons (kept normal, not inverted) */}
          <motion.div
            className="flex flex-wrap gap-4 ml-2 mix-blend-normal"
