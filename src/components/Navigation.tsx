...
export const Navigation = () => {
  return (
    <motion.nav
      className="fixed top-0 left-0 right-0 z-50 px-6 py-6 bg-white/90 backdrop-blur-sm"
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <button className="md:hidden p-2 rounded-lg bg-black text-white hover:bg-black/80 transition-colors">
